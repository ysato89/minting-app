...
const data = {
  rows: [
    ...
    {
      title: 'WHAT’S THE DIFFERENCE BETWEEN A MEMORY, A DREAM AND AN EXPERIENCE?',
      content: (
        <p>
          <span>
            We don’t claim to know the answer to that, but here are some links to people who do:
          </span>
          <br />
